...
Check the [releases](https://github.com/droboports/htop/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/htop.git
cd htop
./build.sh
ls -la *.tgz
```
